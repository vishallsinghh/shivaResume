          ...
          <ol className="relative border-l border-base-300 border-opacity-30 my-2 mx-4">
            {loading ? (
              ...
              <>
                 <ListItem
                    time={`2019 - 2022`}
                    degree={`Bachelor of Computer Applications (BCA), 70.60%`}
                    institution={`College of Engineering Roorkee (COER), Roorkee, India`}
                  />
                  <ListItem
                    time={`2022 - 2024`}
                    degree={`Master of Computer Applications (MCA), GPA 6.82`}
